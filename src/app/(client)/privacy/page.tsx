...
export const lastUpdated = '23.04.2026';
const sections = [
  {
    id: 'intro',
    title: null,
  ...
  },
  {
    ...
    paragraphs: [
      `Під час використання системи можуть оброблятись такі персональні дані користувачів: прізвище, ім'я, по батькові, унікальний ідентифікатор облікового запису «KPI ID», відомості про навчання (академічна група, курс, формат навчання, факультет або інститут).`,
  ...
  },
  {
    ...
    paragraphs: [
      `Персональна інформація використовується виключно для цілей, зазначених у цій Політиці. Зокрема, персональні дані можуть використовуватися для автентифікації користувача та надання доступу до голосувань, перевірки права на участь у конкретному голосуванні відповідно до обмежень за факультетом або академічною групою, а також для запобігання повторному голосуванню. Система побудована таким чином, що зміст вашого голосу в анонімних опитуваннях є конфіденційним навіть для адміністраторів.`,
