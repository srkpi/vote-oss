...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const created = await prisma.electionCampaign.create({
    data: {
      ...
      registration_days: data.registrationDays,
      registration_review_days: data.registrationReviewDays,
      registration_opens_time: data.registrationOpensTime,
      registration_closes_time: data.registrationClosesTime,
      signature_collection: data.signatureCollection,
      signature_days: data.signatureDays,
      signature_review_days: data.signatureReviewDays,
      signature_quorum: data.signatureQuorum,
      signatures_opens_time: data.signaturesOpensTime,
      signatures_closes_time: data.signaturesClosesTime,
